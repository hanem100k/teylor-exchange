...
exports.UpdateUserProfilesInteractor = void 0;
...
class UpdateUserProfilesInteractor extends Interactor_1.Interactor {
    exec(requestModel) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const res = yield superagent_1.default
                    .post(userServiceUrl + constants_1.METHOD_NAME)
                    .send(requestModel);
                return res.body;
            }
            catch (err) {
...
exports.UpdateUserProfilesInteractor = UpdateUserProfilesInteractor;
//# sourceMappingURL=UpdateUserProfilesInteractor.js.map