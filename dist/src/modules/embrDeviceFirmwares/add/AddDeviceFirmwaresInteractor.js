...
exports.AddDeviceFirmwaresInteractor = void 0;
...
class AddDeviceFirmwaresInteractor extends Interactor_1.Interactor {
    exec(requestModel) {
        return __awaiter(this, void 0, void 0, function* () {
            const secretCache = SecretCacheProvider_1.SecretCacheProvider.getInstance();
            const firmwareServiceUrl = yield secretCache.getSingleSecret(process.env.FIRMWARE_SERVICE_HOSTNAME);
            try {
...
exports.AddDeviceFirmwaresInteractor = AddDeviceFirmwaresInteractor;
//# sourceMappingURL=AddDeviceFirmwaresInteractor.js.map